...
exports.getPrivateKeyFromMnemonic = exports.validateMnemonic = exports.generateMnemonic = exports.getPrivateKeyFromKeyStore = exports.generateKeyStore = exports.verifySignature = exports.generateSignature = exports.getAddressFromPrivateKey = exports.getAddressFromPublicKey = exports.generatePubKey = exports.getPublicKeyFromPrivateKey = exports.getPublicKey = exports.generateRandomArray = exports.generatePrivateKey = exports.encodeAddress = exports.encodePubKeyToCompressedBuffer = exports.checkAddress = exports.decodeAddress = void 0;
...
var encodePubKeyToCompressedBuffer = function encodePubKeyToCompressedBuffer(pubKey) {
  ...
  var pubBytes = Buffer.concat([Buffer.alloc(1, prefix), pubKey.x.toArrayLike(Buffer, "be", 32)]);
  return pubBytes;
};
/**
...
var encodeAddress = function encodeAddress(value) {
  var prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "bitsong";
...
var getPrivateKeyFromMnemonic = function getPrivateKeyFromMnemonic(mnemonic) {
  var hdpath = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "44'/118'/0'/0/";
