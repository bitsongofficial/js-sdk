...
var BitSongClient = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(BitSongClient, [{
    ...
    key: "unbond",
    value: function () {
      var _unbond = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee8(validator_address, amount) {
        var memo,
            fee,
            sequence,
            msg,
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                fee = _args8.length > 3 ? _args8[3] : undefined;
                sequence = _args8.length > 4 && _args8[4] !== undefined ? _args8[4] : "";
                msg = {
              ...
              case 11:
                ...
                return _context8.abrupt("return", this.broadcast(signedTx));
    ...
    key: "redelegate",
    value: function () {
      var _redelegate = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee9(validator_src_address, validator_dst_address, amount) {
        var memo,
            fee,
            sequence,
            msg,
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                fee = _args9.length > 4 ? _args9[4] : undefined;
                sequence = _args9.length > 5 && _args9[5] !== undefined ? _args9[5] : "";
                msg = {
              ...
              case 11:
                ...
                return _context9.abrupt("return", this.broadcast(signedTx));
      ...
      function redelegate(_x10, _x11, _x12) {
    ...
    value: function () {
      var _withdrawDelegationReward = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee10(validator_address) {
        var commission,
            memo,
            fee,
            sequence,
        ...
        return _regenerator["default"].wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                commission = _args10.length > 1 && _args10[1] !== undefined ? _args10[1] : false;
                memo = _args10.length > 2 && _args10[2] !== undefined ? _args10[2] : "";
                fee = _args10.length > 3 ? _args10[3] : undefined;
                sequence = _args10.length > 4 && _args10[4] !== undefined ? _args10[4] : "";
                msgs = [];
                msg = {
              ...
              case 13:
                _context10.next = 15;
                return this.buildTransaction(msgs, memo, fee);

              case 15:
                signedTx = _context10.sent;
                return _context10.abrupt("return", this.broadcast(signedTx));
      ...
      function withdrawDelegationReward(_x13) {
