...
* [encodePubKeyToCompressedBuffer](README.md#const-encodepubkeytocompressedbuffer)
...
### `Const` encodePubKeyToCompressedBuffer

▸ **encodePubKeyToCompressedBuffer**(`pubKey`: any): *Buffer‹›*
...
▸ **getPrivateKeyFromMnemonic**(`mnemonic`: string, `hdpath`: string, `derive`: boolean, `index`: number, `password`: string): *string*
...
`hdpath` | string | "44'/118'/0'/0/" | (default: 44'/118'/0'/0/) |
